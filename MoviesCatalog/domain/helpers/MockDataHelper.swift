...
class MockDataHelper {
    static func getMockGenre() -> Genre {
        Genre(id: "3b781828-f329-4785-aecd-08d9b9f3d27c", name: "комедия")
    }

    static func getShortReview() -> ShortReview {
        ShortReview(id: "1cd372ad-8f1d-43b5-4770-08daaed03975", rating: 5)
    }
    ...
    static func getMockMovie() -> Movie {
        Movie(
            ...
            year: 1994,
            country: "США",
            genres: [getMockGenre()].repeated(count: 5),
            reviews: [getShortReview()].repeated(count: 3)
        )
    }
}
